...
export default function Welcome(props) {
    return (
        <>
            <Head title="Welcome" />
            <div className="relative sm:flex sm:justify-center flex-col sm:items-center min-h-screen bg-center bg-gradient-to-br from-blue-900 to-sky-600 selection:bg-red-500 selection:text-white">
                <div className="sm:fixed sm:top-0 sm:left-0 sm:right-0 text-right shadow-soft-sm w-full rounded-5 bg-white/25">
                    <div className="container p-6 w-full">
                        {props.auth.user ? (
                            <Link
                                href={route('dashboard')}
                                className="font-semibold text-white hover:text-gray-200 dark:text-gray-400 dark:hover:text-white"
                            >
                                Dashboard
                            </Link>
                        ) : (
                ...
                <div className="max-w-7xl mx-auto p-6 lg:p-8 ">
                    <div className="w-60 overflow-clip">
                        <img src="/assets/images/logos/spp-logo.png" alt="" className="w-full" />
                    </div>
                    {/* <div className="mt-16">
                ...
                <div className=" text-2xl text-white dark:text-gray-400 ">
                    Bayar SPP!! Biar Sekolah Kita Lebih Maju
                </div>
            </div >
